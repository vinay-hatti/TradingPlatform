...
export function CommandCenter(){
  ...
  useEffect(()=>{void load()},[]);
  const ready=data?.readiness??{};const services=ready.services??[];const fresh=ready.freshness??[];const alerts=data?.alerts??[];const runs=data?.workflow_runs??[];const graph=data?.dependency_graph??{nodes:[],edges:[]};const componentErrors=data?.component_errors??{};
