...
export JOB_NAME="end_of_day_full_ingestion"
export LOCK_NAME="m69_6_market_pipeline"
export LOG_FILE="/Users/vinay.hatti/TradingPlatform/logs/m69_6_end_of_day_ingestion.log"
...
run_cmd "${UV_BIN}" run python scripts/run_intraday_active_universe_shadow.py eod
run_cmd "${UV_BIN}" run python scripts/run_intraday_exclusion_progression_certification.py eod
