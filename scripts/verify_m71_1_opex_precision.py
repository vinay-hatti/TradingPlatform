...
for token in ('DOMINANT-SCENARIO ACTIONABLE RANGE','Model-combined evidence ranges','Path probabilities to key levels','Why is the range this wide?','Event-conditioned distributions','Structural vs tactical dealer positioning'):
