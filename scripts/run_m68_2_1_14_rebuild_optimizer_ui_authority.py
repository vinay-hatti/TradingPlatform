...
VERSION = "M68.2.1.14-OPTIMIZER-UI-AUTHORITY-RECOVERY-1.0"
CONFIRMATION = "REBUILD_M68_2_1_14_OPTIMIZER_UI_AUTHORITY"
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Rebuild M68.2.1.14/M64 optimizer-aware authority"
    )
