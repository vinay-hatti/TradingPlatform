...
assert OpexIntelligenceService.VERSION.startswith(('M71.3','M71.4'))
...
for token in ('Heuristic scenario evidence','Scenario-weighted day-by-day path through OPEX','Historical OPEX analogs','transition_probability_matrix'):
