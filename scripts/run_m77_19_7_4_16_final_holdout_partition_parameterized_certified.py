...
def main()->int:
    ...
    ap.add_argument("--active-partition-label",choices=("PRE_HOLDOUT","FINAL_HOLDOUT"),default="PRE_HOLDOUT")
    ap.add_argument("--partition-start",default="2023-01-01")
    ap.add_argument("--partition-end",default="2026-08-21")
    ...
    for sm in weekly:
        ...
        for row in iter_jsonl(f):
            ...
            if args.active_partition_label=="PRE_HOLDOUT":
                ...
                if as_of<args.partition_start or as_of>args.partition_end:
                    continue
            p=row.get("profile")
    ...
    for as_of in dates:
        ...
        rec={
            "as_of":as_of,
            "partition":("FINAL_HOLDOUT" if args.active_partition_label=="FINAL_HOLDOUT" else ("DEVELOPMENT" if as_of<="2017-12-31" else "VALIDATION")),
    ...
    summary={
        ...
        "final_holdout_protection":{
            ...
            "context_rows_materialized":sum(r["partition"]=="FINAL_HOLDOUT" for r in rows),
