...
export function DailyScannerPage(){
  ...
  return <section>
    ...
    <Card title="Market ingestion"><div className="scanner-form"><div className="scanner-actions"><button className="primary" disabled={busy} onClick={scan}>Run database-only daily scan</button></div></div></Card>
