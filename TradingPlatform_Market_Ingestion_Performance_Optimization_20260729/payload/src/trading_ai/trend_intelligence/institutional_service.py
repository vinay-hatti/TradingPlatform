...
class InstitutionalTrendService:
    ...
    def run(self, symbols: Iterable[str], start: str, end: str, report_path: str = "reports/trend_intelligence/institutional_latest.json", price_data: dict[str, pd.DataFrame] | None = None) -> dict:
        ...
        data = price_data if price_data is not None else self._load_prices(load_targets, start, end)
