...
import { CommandCenter, DailyScannerPage, Execution, Exits, MarketOverviewPage, ProposedMarketOverviewPage, nav, Overview, Portfolio, Positions, Risk } from './pages';
import './styles.css';

const pages: Record<WorkspaceKey, ComponentType> = {
  overview: Overview,
  market: MarketOverviewPage,
  'market-proposed': ProposedMarketOverviewPage,
