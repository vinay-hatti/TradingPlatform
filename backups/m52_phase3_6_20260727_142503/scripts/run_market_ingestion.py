...
def main(argv=None) -> int:
    ...
    args = _validate_option_controls(_resolve_force_controls(build_parser().parse_args(argv)))
        ...
        if args.reuse_options_snapshot:
            ...
            manifest.complete_cycle(
                ...
                metadata={
                    ...
                    "completed_successfully": profile.failed_batches == 0,
                },
            )
            write_ingestion_profile_json(profile, args.options_report)
            failed += profile.failed_batches
            options_refreshed = profile.failed_batches == 0 or profile.valid_records > 0
            print(
