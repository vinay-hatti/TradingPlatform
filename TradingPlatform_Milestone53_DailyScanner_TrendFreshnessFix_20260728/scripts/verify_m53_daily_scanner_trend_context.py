...
def main() -> None:
    ...
    parser.add_argument("--maximum-age-days", type=int, default=3)
    ...
    for raw in args.symbols.split(","):
        ...
        rows.append({
            ...
            "forecast": forecast.scanner_context(
                ...
                maximum_age_days=args.maximum_age_days, reference_date=args.reference_date,
            ),
            "institutional": institutional.scanner_context(
                symbol, maximum_age_days=args.maximum_age_days, reference_date=args.reference_date,
            ),
        })
