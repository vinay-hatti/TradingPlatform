...
class DailyScanner:
    ...
    def scan_symbol(self, symbol):
        ...
        if forecast_context["forecast_context_status"] == "FRESH":
            ranking_reason += f" | Forecast {forecast_context['forecast_direction']}; confidence={forecast_context['forecast_confidence_score']:.1f}, adjustment={forecast_adjustment:+.2f}."
