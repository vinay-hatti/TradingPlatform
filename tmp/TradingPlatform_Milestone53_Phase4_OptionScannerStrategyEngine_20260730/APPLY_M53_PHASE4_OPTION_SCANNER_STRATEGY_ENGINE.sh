...
BACKUP="$TARGET/.m53_phase4_backup_$STAMP"
...
cp "$PACKAGE_DIR/scripts/test_m53_phase4_option_scanner_strategy_engine.py" "$TARGET/scripts/test_m53_phase4_option_scanner_strategy_engine.py"
printf '%s\n' "$BACKUP" > "$TARGET/.m53_phase4_last_backup"
echo "Applied Milestone 53 Phase 4. Backup: $BACKUP"
