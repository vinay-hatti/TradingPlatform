    ...
    {isOptionWorkspace&&<>
      ...
      <div className="option-scanner-control-grid">
        ...
        {experienceMode!=='basic'&&<article className="control-section">
          <div className="control-section-heading"><div><span>04</span><h3>Persisted-data governance</h3></div><p>Review the authoritative snapshot used by this read-only decision workspace.</p></div>
          <div className="control-fields">
