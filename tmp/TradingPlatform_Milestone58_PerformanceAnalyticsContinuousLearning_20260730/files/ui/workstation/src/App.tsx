...
import { CommandCenter, DailyScannerPage, Execution, Exits, MarketOverviewPage, nav, OptionScannerPage, OpportunityWorkspacePage, Overview, Portfolio, Positions, Risk } from './pages';
import './styles.css';
...
const pages: Record<WorkspaceKey, ComponentType> = {
  ...
  'option-scanner': OptionScannerPage,
  opportunities: OpportunityWorkspacePage,
  intelligence: InstitutionalIntelligencePage,
  'trade-builder': AdvancedTradeBuilderPage,
  portfolio: PortfolioIntelligencePage,
  'performance-learning': PerformanceLearningPage,
  risk: Risk,
  execution: Execution,
  positions: Positions,
  exits: Exits,
